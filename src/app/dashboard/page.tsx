...
import { Calendar, Download, MoreHorizontal, ArrowUpRight, ArrowDownRight, Star } from "lucide-react";
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button className="rounded-xl bg-black text-white hover:bg-black/90 flex items-center gap-2 text-xs font-semibold">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="rounded-2xl border shadow-sm bg-gradient-to-br from-indigo-50/50 via-white to-purple-50/50 relative overflow-hidden flex flex-col justify-between">
            <CardHeader className="pb-2">
              <CardTitle className="text-xl font-black">Congratulations Toby! 🎉</CardTitle>
              <CardDescription className="text-xs text-muted-foreground">Best seller of the month</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 pt-2">
              <div>
                <div className="text-2xl font-bold tracking-tight">$15,231.89</div>
              ...
              <Button size="sm" variant="outline" className="rounded-xl text-xs font-semibold bg-white shadow-sm">
                View Sales
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-2xl border shadow-sm flex flex-col justify-between">
            ...
            <CardContent className="space-y-4">
              <div className="text-3xl font-black tracking-tight">$34.1K</div>
          ...
          <Card className="rounded-2xl border shadow-sm flex flex-col justify-between">
            ...
            <CardContent className="space-y-4">
              <div className="text-3xl font-black tracking-tight">500.1K</div>
              <div className="text-xs text-primary font-medium flex items-center gap-1 cursor-pointer hover:underline">
                View more &rarr;
              </div>
            </CardContent>
          ...
          <Card className="rounded-2xl border shadow-sm flex flex-col justify-between">
            ...
            <CardContent className="space-y-4">
              <div className="text-3xl font-black tracking-tight">11.3%</div>
              <div className="text-xs text-primary font-medium flex items-center gap-1 cursor-pointer hover:underline">
                View more &rarr;
              </div>
            </CardContent>
            ...
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              <div className="flex gap-4 text-xs font-semibold">
                <div>
                  ...
                  <span className="text-base font-bold">24,828</span>
                </div>
                <div>
                  <span className="text-muted-foreground block text-[10px]">MOBILE</span>
                  <span className="text-base font-bold">25,010</span>
                </div>
              </div>
            </CardHeader>
            <CardContent className="pt-4">
              <ResponsiveContainer width="1005" height={240}>
                <BarChart data={barData}>
                  <XAxis dataKey="name" stroke="#888888" fontSize={11} tickLine={false} axisLine={false} />
                  <Bar dataKey="total" fill="currentColor" radius={[6, 6, 0, 0]} className="fill-slate-800" />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
            ...
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-2xl font-black">$42,379</span>
            ...
            <CardContent className="pt-4">
              <ResponsiveContainer width="100%" height={240}>
                <LineChart data={lineData}>
                  <XAxis dataKey="name" stroke="#888888" fontSize={11} tickLine={false} axisLine={false} />
                  <Line type="monotone" dataKey="value1" stroke="#000000" strokeWidth={2} dot={false} />
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <Card className="rounded-2xl border shadow-sm flex flex-col justify-between">
            ...
            <CardContent className="flex flex-col items-center justify-center py-6">
              <div className="text-4xl font-black tracking-tight">10.2K</div>
              ...
              <div className="flex flex-wrap gap-4 text-xs font-medium text-muted-foreground justify-center">
                <span className="flex items-center gap-1.5"><span className="h-2 w-2 rounded-full bg-black"></span> Direct</span>
          ...
          <Card className="rounded-2xl border shadow-sm">
            ...
            <CardContent className="space-y-4 pt-2">
              <div className="flex items-center gap-4">
                <div className="text-3xl font-black">4.5</div>
                <div>
